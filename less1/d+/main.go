...
// Дано N золотых слитков массой m1, m2, ..., mN. Ими наполняют рюкзак, который выдерживает
// вес не более M. Какую наибольшую массу золота можно унести в таком рюкзаке?

func solve(M int, mm []int) int {
	dp := make([]bool, M+1)
	dp[0] = true
